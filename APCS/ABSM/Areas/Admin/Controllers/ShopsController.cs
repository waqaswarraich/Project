   ...
   [Authorize(Roles ="Admin")]
    public class ShopsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            var shopkeepers = db.Users.Where(x => x.Roles.Select(y => y.RoleId).Contains("339bf8d4-79ef-405d-b1c6-0eeaeb5a92d1"))
        ...
        public ActionResult Upload(HttpPostedFileBase file)
        {
            ...
            if (file != null)
            {
                ...
                if (extension == ".jpg" || extension == ".png" || extension == ".jpeg")
                {
                    path = HostingEnvironment.MapPath(Path.Combine("~/Content/Images/Slider/", filename));
                    file.SaveAs(path);
                    fileupload.ImageUrl = "~/Content/Images/Slider/" + filename;
